...
### Théo: 
Ce projet m'a permis d'aguérir de nouvelles compétences techniques mais aussi organisationnelles et relationnelles dans la gestion de projets orientés Data. Je pense qu'il aurait pû être pertinent de développer les manières de partager une analyse exploratoire d'un dataset afin d'en faire un réel support de réflexion et imaginer les moyens de présenter des résultats au plus grand nombre.
