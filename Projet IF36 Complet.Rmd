...
```{r diagrammeRépartitionDalcWalc, fig.align='center'}
...
```{r diagrammeSexe, fig.align='center'}
...
```{r diagrammeAge, fig.align='center'}
...
```{r Question 2 : Identifier les sportifs, fig.align='center'}
#Question 1 :
...
```{r Question 2 : Voir les résultats moyens de chaque étudiants, fig.align='center'}
#Question 1 :
#Faire du sport permet-il vraiment dâ€™avoir de meilleurs résultats scolaires ?
...
```{r Question 2 : Visu 1 joint, fig.align='center'}
#Question 1 :
#Faire du sport permet-il vraiment dâ€™avoir de meilleurs résultats scolaires ?
...
```{r Question 2 : Visu 2 por, fig.align='center'}
#Question 1 :
#Faire du sport permet-il vraiment dâ€™avoir de meilleurs résultats scolaires ?
...
```{r Question 2 : Visu 3 mat, fig.align='center'}
#Question 1 :
#Faire du sport permet-il vraiment dâ€™avoir de meilleurs résultats scolaires ?
...
```{r Question 2 : Visu 3 por - activities, fig.align='center'}
#Question 1 :
#Faire du sport permet-il vraiment dâ€™avoir de meilleurs résultats scolaires ?
...
```{r distributionBoxplot, fig.align='center'}
...
```{r distributionViolin, fig.align='center'}
# Créer un graphique pour comparer les notes 
ggplot(data, aes(x = geek, y = moyenneNote)) +
...
```{r repartitionScatterplot, fig.align='center'}
...
```{r quantitePersonnes, fig.align='center'}
count_data <- data %>%
  count(geek)
...
```{r repartitionHommeFemme, fig.align='center'}
...
```{r moyeneHommeFemme, fig.align='center'}
means <- data %>%
  group_by(sex) %>%
...
ggplot(means, aes(x = sex, y = mean_math_score, fill = sex)) +
  ...
  labs(title = "Moyenne des notes en mathématiques entre hommes et femmes",
       ...
       fill = "Sexe") +
  scale_fill_manual(values = c("green", "red")) +  # Couleurs pour les hommes (bleu) et les femmes (rose)
  theme_minimal()
...
```{r RedefintionMat, include=FALSE, fig.align='center'}
...
```{r diagrammeConsoAlcoolMat, fig.align='center'}
...
```{r diagrammeConsoAlcoolPort, fig.align='center'}
...
```{r diagrammePortugaisRassemblement, fig.align='center'}
...
```{r diagrammeRedoublementComparaison, fig.align='center'}
...
```{r correlationEtudeMere, fig.align='center'}
...
```
```{r correlationEtudePere, fig.align='center'}
...
``` 
```{r correlationEtudeParent, fig.align='center'}
