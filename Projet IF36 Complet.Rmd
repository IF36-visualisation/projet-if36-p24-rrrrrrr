...
ggplot(df_summary, aes(x = higher, y = percentage, fill = address)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "Pourcentage d'étudiants souhaitant poursuivre une éducation supérieure en fonction de leur milieu de vie",
